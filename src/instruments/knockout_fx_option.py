...
from src.pricing_models.fx_option_pricer import get_fx_market_data
from src.pricing_models.knockout_fx_pricer import create_knockout_fx_option
...
class KnockOutFXOption(InstrumentModel):
    ...
    def _setup_pricing_components(self) -> None:
        ...
        market_data = get_fx_market_data(self.currency_pair, self.calculation_date)
        ...
        ql_calc = to_ql_date(self.calculation_date)
